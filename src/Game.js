  ...
  play(c) {
    if (!this.state.gameOver) {
      ...
      if (result === this.state.player1) {
        this.setState({ board: board, gameOver: true, message: this.state.player1name + ' wins!' });
      } else if (result === this.state.player2) {
        this.setState({ board: board, gameOver: true, message: this.state.player2name + ' wins!' });
      } else if (result === 'draw') {
