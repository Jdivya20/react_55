...
const Search = () => {
  ...
  return (
    <div>
      ...
      <input type="text" placeholder="enter your name"onChange={e => changep1Name(e.target.value)}></input>
      <br></br>
      <label>Player 2 : </label>
      <input type="text" placeholder="enter your name"onChange={e => changep2Name(e.target.value)}></input>
      <br></br>
      <br></br>
